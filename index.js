...
const game = ({
  ...
  function loop() {
    const image_data = imageData.data.slice(0);
    ...
    for(let r = 0; r < rows; r++) { //row
      for(let c = 0; c < cols; c++) { //col
        ...
        const count =
        ((not_top_row && not_first_col && (image_data[(prev_bit - bits_in_row)])) ? 1 : 0) +
        ((not_top_row && (image_data[(i - bits_in_row)])) ? 1 : 0) +
        ((not_top_row && not_last_col && (image_data[(next_bit - bits_in_row )])) ? 1 : 0) +
        ((not_first_col && (image_data[(prev_bit)])) ? 1 : 0) +
        ((not_last_col && (image_data[(next_bit)])) ? 1 : 0) +
        ((not_first_col && not_bottom_row && (image_data[(prev_bit + bits_in_row)])) ? 1 : 0) +
